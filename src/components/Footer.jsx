            ...
            <div className="flex flex-wrap md:w-3/4 justify-between">               
              ...
              <div className="w-1/2 sm:w-1/3 mb-8">                 
                ...
                <ul className="space-y-3 md:space-y-4 text-base md:text-lg">                   
                  <li>
                    <Link to="/products/01" className="hover:text-teal-200 transition-colors inline-flex items-center">
                      <span className="mr-2">—</span> Pigments
                    </Link>
                  </li>                   
                  <li>
                    <Link to="/products/02" className="hover:text-teal-200 transition-colors inline-flex items-center">
                      <span className="mr-2">—</span> Dyes
                    </Link>
                  </li>                   
                  <li>
                    <Link to="/products/03" className="hover:text-teal-200 transition-colors inline-flex items-center">
                      <span className="mr-2">—</span> Pharmaceutical APIs
                    </Link>
                  </li>                   
                  <li>
                    <Link to="/products/04" className="hover:text-teal-200 transition-colors inline-flex items-center">
                      <span className="mr-2">—</span> Constructional Chemicals
                    </Link>
                  </li>                   
                  <li>
                    <Link to="/products/05" className="hover:text-teal-200 transition-colors inline-flex items-center">
              ...
              <div className="w-1/2 sm:w-1/3 mb-8">                                
                ...
                <li>
                  ...
                  <li>
                    <Link to="/contactus" className="hover:text-teal-200 transition-colors">
                     CONTACT US
                    </Link>
                  </li>                     
                </ul>               
              ...
              <div className="w-full sm:w-1/3 mb-8">                 
                ...
                <ul className="space-y-3 md:space-y-4 text-base md:text-lg">                   
                  <li>
                    <a href="https://maps.app.goo.gl/uS4ZJyvcehiAJVaK9" target="_blank" rel="noopener noreferrer" className="hover:text-teal-200 transition-colors">
